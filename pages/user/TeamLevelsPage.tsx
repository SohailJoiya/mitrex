          ...
          >
            <div className="p-8 text-white flex flex-col h-full">
              ...
              <div className="mt-8 space-y-5 flex-grow">
                <RequirementItem
                  icon={<Icon path="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01" className={`h-6 w-6 ${level.theme.iconColor}`} />}
                  label="Investment Range"
                  value={level.investment}
                />
                {level.directMembers !== undefined && (
                  <RequirementItem
                    icon={<Icon path="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" className={`h-6 w-6 ${level.theme.iconColor}`} />}
